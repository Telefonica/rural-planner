...
shinyUI(dashboardPage(
  ...
  dashboardHeader( 
    ...
    tags$li(class="dropdown",div(img(height = 33, width = 48, src= "brasil_logo.png", align="right"),style="padding-top:10px; padding-right:10px"))
  ),
  ...
  dashboardSidebar(
    ...
    sidebarMenu( id= 'sidebarmenu',
                 ...
                 # FILTERS: estado, municipio and distrito
                 
                 conditionalPanel("input.sidebarmenu === 'segmentation'",
                                  
                                  selectizeInput("estado",'Estado', c("TODOS",unique(input_tab_2$estado)), multiple= TRUE, 
                                                 selected='TODOS', options = list(maxOptions = 27, placeholder = 'Introduzca estado'))
                 ),
                 
                 conditionalPanel("input.sidebarmenu === 'segmentation'", (uiOutput("municipio"))),
                 
                 conditionalPanel("input.sidebarmenu === 'segmentation'", (uiOutput("distrito"))),
                 
                 menuItem("Priorización CCPP", tabName = "priorization", icon = icon("th")),
                 
                 # FILTERS: distrito, municipio, estado, Overlay segment, Greenfield segment, Movistar coverage, Competitors coverage and number of secondary schools
                 conditionalPanel("input.sidebarmenu === 'priorization'",
                                  selectizeInput("estado_2",'Estado', c("TODOS",unique(input_tab_2$estado)), multiple= FALSE, 
                                                 selected='Acre', options = list(maxOptions = 27, placeholder = 'Introduzca estado'))
                 ),
                 
                 conditionalPanel("input.sidebarmenu === 'priorization'", (uiOutput("municipio_2"))),
                 
                 conditionalPanel("input.sidebarmenu === 'priorization'", (uiOutput("distrito_2"))),
                 
                 conditionalPanel("input.sidebarmenu === 'priorization'",
                                  (checkboxGroupInput("segmento",'Segmento', unique(input_tab_2$segmentacion[!is.na(input_tab_2$segmentacion)]),
                                                      selected= unique(input_tab_2$segmentacion[!is.na(input_tab_2$segmentacion)]) ))
                 ),
                 
                 conditionalPanel("input.sidebarmenu === 'priorization'",
                                  (uiOutput("cobertura_vivo"))),
                 ...
                 conditionalPanel("input.sidebarmenu === 'listing'",
                                  selectizeInput("estado_listing",'Estado', c("TODOS",unique(input_tab_2$estado)), multiple= TRUE, 
                                                 selected='TODOS', options = list(maxOptions = 27, placeholder = 'Introduzca estado'))
                 ),
                 
                 conditionalPanel("input.sidebarmenu === 'listing'", (uiOutput("municipio_listing"))),
                 
                 conditionalPanel("input.sidebarmenu === 'listing'", (uiOutput("distrito_listing"))),
                 
                 conditionalPanel("input.sidebarmenu === 'listing'",
                                  (checkboxGroupInput("segmento_listing",'Segmento',unique(input_tab_2$segmentacion[!is.na(input_tab_2$segmentacion)]),
                                                      selected= unique(input_tab_2$segmentacion[!is.na(input_tab_2$segmentacion)]) ))
                 ),
                 
                 conditionalPanel("input.sidebarmenu === 'listing'", (uiOutput("cobertura_vivo_listing"))),
                 
                 conditionalPanel("input.sidebarmenu === 'listing'", (uiOutput("cobertura_competidores_listing"))),
                 ...
                 conditionalPanel("input.sidebarmenu === 'priorization_clusters'",
                                  selectizeInput("estado_3",'Estado',c("TODOS",unique(input_tab_2$estado)), multiple= TRUE, 
                                                 selected='Acre', options = list(maxOptions = 27, placeholder = 'Introduzca estado/estados'))
                 ),
                 
                 conditionalPanel("input.sidebarmenu === 'priorization_clusters'", (uiOutput("municipio_3"))),
                 
                 conditionalPanel("input.sidebarmenu === 'priorization_clusters'", (uiOutput("distrito_3"))),
                 
                 conditionalPanel("input.sidebarmenu === 'priorization_clusters'",
                                  (checkboxGroupInput("segmento_2",'Segmento',unique(input_tab_3$segmentacion[!is.na(input_tab_3$segmentacion)]),
                                                      selected= unique(input_tab_3$segmentacion[!is.na(input_tab_3$segmentacion)]) ))
                 ),
                 ...
                 conditionalPanel("input.sidebarmenu === 'priorization_clusters'",
                                  (sliderInput("poblacion_3",'Numero de habitantes cluster',0,100000,c(0,2000)))),
                 ...
                 conditionalPanel("input.sidebarmenu === 'listing_clusters'",
                                  selectizeInput("estado_3_listing",'Estado',c("TODOS",unique(input_tab_2$estado)), multiple= TRUE, 
                                                 selected='Acre', options = list(maxOptions = 27, placeholder = 'Introduzca estado/estados'))
                 ),
                 
                 conditionalPanel("input.sidebarmenu === 'listing_clusters'", (uiOutput("municipio_3_listing"))),
                 
                 conditionalPanel("input.sidebarmenu === 'listing_clusters'", (uiOutput("distrito_3_listing"))),
                 
                 conditionalPanel("input.sidebarmenu === 'listing_clusters'",
                                  (checkboxGroupInput("segmento_2_listing",'Segmento',unique(input_tab_3$segmentacion[!is.na(input_tab_3$segmentacion)]),
                                                      selected= unique(input_tab_3$segmentacion[!is.na(input_tab_3$segmentacion)])))
                 ),
                 ...
                 conditionalPanel("input.sidebarmenu === 'listing_clusters'",
                                  (sliderInput("poblacion_4",'Numero de habitantes cluster',0,100000,c(0,2000)))
                 )
    )
  ),
    ...
    tabItems(
      ...
      tabItem(tabName = "segmentation",
              ...
              fluidRow(
                ...
                column(6, div(h2(strong("Segmentación Oportunidad Telefónica Brasil")),style="padding-top:15px; text-align: center; color:#00334d;")),
      ...
      tabItem(tabName = "priorization",
              ...
              fluidRow(
                column(3, div(img(height = 40, width = 136, src= "tef_logo.png"),style="padding-top:35px; padding-left:25px")),
                column(6, div(h2(strong("Priorización Centros Poblados Telefónica Brasil")),style="padding-top:15px; text-align: center; color:#00334d;")),
                column(3, div(img(height = 120, width = 150, src= "ipt_logo.png", align="right")))
              ),
              ...
              fluidRow(
                ...
                column( 6, 
                        ...
                        # Text output:
                        fluidRow (
                          box(title= "Número de centros poblados", status= "primary", solidHeader = TRUE, height= "110px", width= 6, h3(textOutput("sum_settlements"))), 
                          box(title= "Población incluida", status= "primary", solidHeader = TRUE,  height= "110px", width= 6, h3(textOutput("sum_population")))
                        ),
                        
                        # Dataframe output
                        box(dataTableOutput("outputdf"), width = "100%", height= "700px"),
      ...
      tabItem(tabName = "listing",
              ...
              fluidRow(
                column(3, div(img(height = 40, width = 136, src= "tef_logo.png"),style="padding-top:35px; padding-left:25px")),
                column(6, div(h2(strong("Listado Centros Poblados Telefónica Brasil")),style="padding-top:15px; text-align: center; color:#00334d;")),
                column(3, div(img(height = 120, width = 150, src= "ipt_logo.png", align="right")))
              ),
              ...
              fluidRow(
                # Text output:
                fluidRow(div (box(title= "Número de CCPP", status= "primary", solidHeader = TRUE, height= "110px", width= 5, h3(textOutput("sum_settlements_listing"))) , 
                              box(title= "Población incluida", status= "primary", solidHeader = TRUE,  height= "110px", width= 5,
                                  h3(textOutput("sum_population_listing"))),style="padding-left:150px;padding-right:150px;")
                ),
                ...
                # Dataframe output
                div(box(dataTableOutput("outputdf_listing"), width = "80%", height= "700px"),
                    style="padding-left:40px;padding-right:40px;"
                )
              )
      ),
      ...
      tabItem(tabName = "priorization_clusters",
              ...
              fluidRow(
                ...
                column(8, div(h2(strong("Priorización Clusters Telefónica Brasil")),style="padding-top:15px; text-align: center; color:#00334d;")),
              ...
              fluidRow(
                ...
                column( 6, 
                        ...
                        fluidRow(box(title= "Número de clusters", status= "primary", solidHeader = TRUE, height= "110px", width= 4, h3(textOutput("sum_clusters"))) , 
                                 box(title= "Número de CCPP", status= "primary", solidHeader = TRUE, height= "110px", width= 4, h3(textOutput("sum_settlements_2"))) , 
                                 box(title= "Pobl. incluida", status= "primary", solidHeader = TRUE,  height= "110px", width= 4, h3(textOutput("sum_population_2")))
                        ),
      ...
      tabItem(tabName = "listing_clusters",
              ...
              fluidRow(
                column(2, div(img(height = 40, width = 136, src= "tef_logo.png"),style="padding-top:35px; padding-left:25px")),
                column(8, div(h2(strong("Listado Clusters Telefónica Brasil")),style="padding-top:15px; text-align: center; color:#00334d;")),
                column(2, div(img(height = 120, width = 150, src= "ipt_logo.png", align="right")))
              ),
              ...
              fluidRow(
                ...
                fluidRow(div(box(title= "Número de clusters", status= "primary", solidHeader = TRUE, height= "110px", width= 4, h3(textOutput("sum_clusters_listing"))),
                             box(title= "Número de CCPP", status= "primary", solidHeader = TRUE, height= "110px", width= 4, h3(textOutput("sum_settlements_2_listing"))),
                             box(title= "Población incluida", status= "primary", solidHeader = TRUE,  height= "110px", width= 4, h3(textOutput("sum_population_2_listing")))
                ), 
                style="padding-left:40px;padding-right:40px;"
                ),
                ...
                # Dataframe output
                div(box(dataTableOutput("outputdf_2_listing"), width = "80%", height= "700px"),
                    style="padding-left:40px;padding-right:40px;"
                )
              )
      )
