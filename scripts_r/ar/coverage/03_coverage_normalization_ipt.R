...
settlements_list <- listSettlements(schema, table_settlements_ipt)
...
truncateTable(schema, indirect_polygons_table)


# AD-HOC: 3 rows since we have infrastructure from Telefonica, Claro, Personal
...
insertIndirectPolygons(schema, indirect_polygons_table, infrastructure_table)
...
settlements_info <- matchSettlementsIds(schema, table_settlements_ipt)
...
regulator_normalized_df <- regulatorNormalized(schema, table_settlements, table_atoll)
...
indirect_normalized_df <- indirectNormalized(schema, table_settlements_ipt, indirect_polygons_table)
...
facebook_normalized_df <- facebookNormalized(schema, table_settlements_ipt, schema_prod, facebook_polygons_tf_table_2g, facebook_polygons_tf_table_3g, facebook_polygons_tf_table_4g)
...
facebook_all_normalized_df <- facebookAllNormalized(schema, table_settlements_ipt, schema_prod, facebook_competitors_polygons_2g, facebook_competitors_polygons_3g, facebook_competitors_polygons_4g)
...
exportCoverage(schema, table_coverage_ipt, coverage)
