## CREATE NORMALIZED ZRD
createNormalizedZRD <- function(schema, table_settlements, table_households, table_admin_division_1, table_admin_division_2){ 
    ...
    query <- paste("INSERT INTO ",schema, ".", table_settlements,"
                   ...
                   SELECT CONCAT(h.admin_division_1_id,'-ZRD') as settlement_id,
                   'ZONA RURAL DISPERSA' as settlement_name,
                   ...
                   NULL as longitude,
                   'ZRD' as source,
                   ST_Collect(h.geom::geometry) as geom,
                   ...
                   WHERE h.cluster IS NULL and h.closest_settlement is null
