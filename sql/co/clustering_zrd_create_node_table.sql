...
CASE WHEN (C.movistar_4g_corrected IS FALSE) THEN S.population_corrected::FLOAT 
     ELSE 0 END AS node_weight,
CASE WHEN (C.movistar_4g_corrected IS TRUE) THEN 'SETTLEMENT ZRD 4G'
     WHEN (C.movistar_3g_corrected IS TRUE) THEN 'SETTLEMENT ZRD 3G'
     WHEN (C.movistar_2g_corrected IS TRUE) THEN 'SETTLEMENT ZRD 2G' 
...
WHERE C.movistar_4g_corrected IS FALSE 
