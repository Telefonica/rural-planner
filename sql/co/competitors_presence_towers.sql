 CREATE TABLE IF NOT EXISTS {schema}.competitors_presence_towers (
                        ...
                        tigo_2g_presence float,
                        tigo_3g_presence float,
                        tigo_4g_presence float,
...
ELSE SUM(population_tigo_2g)::numeric/SUM(population_corrected)::numeric END AS tigo_presence_2g,
CASE WHEN SUM(population_corrected) = 0 THEN 0
ELSE SUM(population_tigo_3g)::numeric/SUM(population_corrected)::numeric END AS tigo_presence_3g,
CASE WHEN SUM(population_corrected) = 0 THEN 0
ELSE SUM(population_tigo_4g)::numeric/SUM(population_corrected)::numeric END AS tigo_presence_4g,
...
FROM (
        ...
        CASE WHEN tigo_2g_corrected IS TRUE THEN population_corrected ELSE 0 END AS population_tigo_2g,
        CASE WHEN tigo_3g_corrected IS TRUE THEN population_corrected ELSE 0 END AS population_tigo_3g,
        CASE WHEN tigo_4g_corrected IS TRUE THEN population_corrected ELSE 0 END AS population_tigo_4g,
