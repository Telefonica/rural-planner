...
SELECT
    ...
    tr.regional_optimal_tower   AS   torre_acceso_regional_optima,
    tr.distance_regional_optimal_tower_m    AS  distancia_torre_acceso_regional_optima,
    tr.third_party_optimal_tower   AS   torre_acceso_terceros_optima,
    tr.distance_third_party_optimal_tower_m    AS   distancia_torre_acceso_terceros_optima,
    ...
    tt.distance_third_party_transport_m   AS  distancia_torre_transporte_terceros_optima
FROM
