...
SELECT
    ...
    ((competitors_presence_towers.cnt_2g_presence)::DOUBLE PRECISION * (100)::DOUBLE PRECISION)
    AS presencia_cnt_2g,
    ((competitors_presence_towers.cnt_3g_presence)::DOUBLE PRECISION * (100)::DOUBLE PRECISION)
    AS presencia_cnt_3g,
    ((competitors_presence_towers.cnt_4g_presence)::DOUBLE PRECISION * (100)::DOUBLE PRECISION)
    AS presencia_cnt_4g,
