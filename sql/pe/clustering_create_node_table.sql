...
WHERE I.tech_3g IS FALSE AND I.tech_4g IS FALSE AND I.owner NOT IN ('CLARO','ENTEL','CLARO FIBER') AND in_service='IN SERVICE'
...
CASE WHEN C.movistar_3g_corrected IS TRUE OR C.movistar_4g_corrected IS TRUE THEN 0
     WHEN (I.tower_id IS NOT NULL) THEN 0
...
LEFT JOIN {schema}.{table_infrastructure} I
ON ST_Within(S.geom::geometry, COALESCE(I.coverage_area_3g, I.coverage_area_4g));
